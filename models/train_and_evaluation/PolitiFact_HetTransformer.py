...
post_nodes = data_loader(pathway='data/processed_data/FakeNewsNet/PolitiFact/batch/normalized_post_nodes/', node_type="post")
user_nodes = data_loader(pathway='data/processed_data/FakeNewsNet/PolitiFact/batch/normalized_user_nodes/', node_type="user")
news_nodes = data_loader(pathway='data/processed_data/FakeNewsNet/PolitiFact/batch/normalized_news_nodes/', node_type="news")
news_emb_dict = {}
post_emb_dict = {}
user_emb_dict = {}
...
def load_train_test(data_real, data_fake, test_index_path_real='models/data_splits/PolitiFact/test_index_real.txt', test_index_path_fake = 'models/data_splits/PolitiFact/test_index_fake.txt'):
