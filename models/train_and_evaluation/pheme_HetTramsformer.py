...
post_nodes = data_loader(pathway='data/processed_data/PHEME/normalized_post_nodes/', node_type="post")
news_nodes = data_loader(pathway='data/processed_data/PHEME/normalized_news_nodes/', node_type="news")
user_nodes = data_loader(pathway='data/processed_data/PHEME/normalized_user_nodes/', node_type="user")
news_emb_dict = {}
post_emb_dict = {}
user_emb_dict = {}
